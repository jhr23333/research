...
CAPEX_WATCHLIST = {
    # 晶圆代工 → 影响设备商订单 + 封测需求
    "foundry": {
        "中芯国际":   {"signal": "资本开支 产能扩张 月产能",   "link": "鹏鼎H2 芯原H1"},
        "华虹半导体": {"signal": "资本开支 无锡产线 新增产能", "link": "鹏鼎H2"},
        "台积电":     {"signal": "资本开支 CoWoS 先进封装",   "link": "芯原H1 芯原H3"},
    },
    ...
    # AI基础设施 → 服务器需求 → PCB需求（鹏鼎最直接）
    "ai_infra": {
        "Amazon AWS":  {"signal": "资本支出 数据中心 服务器",   "link": "鹏鼎H2"},
        "微软 Azure":  {"signal": "资本支出 数据中心 AI基础设施","link": "鹏鼎H2"},
        "谷歌 Google": {"signal": "资本支出 数据中心 TPU",      "link": "鹏鼎H2"},
        "Meta":        {"signal": "资本支出 数据中心 AI服务器", "link": "鹏鼎H2"},
        "字节跳动":    {"signal": "数据中心 服务器采购 算力",   "link": "鹏鼎H2"},
    },

    # 封测 → PCB/基板需求的另一个观测点
    "packaging": {
        "日月光":      {"signal": "资本开支 先进封装 CoWoS",   "link": "鹏鼎H3 芯原H1"},
        "长电科技":    {"signal": "资本开支 产能",              "link": "鹏鼎H3"},
    },
}
